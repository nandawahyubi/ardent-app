            ...
            <div class="col-lg-9 col-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <form action="" class="basic-form" method="POST" autocomplete="off">
                            @csrf
                            <div class="mb-4">
                                <label for="full-name" class="form-label">Full Name</label>
                                <input type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                                    id="full-name" name="name" value="" required>
                                @if ($errors->has('name'))
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}"
                                    id="email" name="email" value="" aria-describedby="emailHelp" required>
                                @if ($errors->has('email'))
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" min="0"
                                    class="form-control {{ $errors->has('no_telp') ? 'is-invalid' : '' }}" id="no_telp"
                                    name="no_telp" value="" required>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input type="text"
                                            ...
                                            id="vehicle_brand" name="vehicle_brand" value="" required>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input type="text"
                                            ...
                                            id="vehicle_color" name="vehicle_color" value="" required>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input type="text"
                                            ...
                                            id="production_year" name="production_year" value="" required>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input type="text" maxlength="15"
                                            ...
                                            id="number_plate" name="number_plate" value="" required>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input type="text"
                                            ...
                                            id="order_schedule" name="order_schedule" onchange="realtimeDate()" value=""
                                            required>
